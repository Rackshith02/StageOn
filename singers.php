    ...
    <div class="container">
      <section class="category-hero">
        ...
        <div class="category-content">
          <h1>Singers</h1>
          <p>Discover vocal talents for live shows, studio sessions, events, and collaborations.</p>
