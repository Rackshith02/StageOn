...
<head>
  ...
  <title>StageOn - Instrumentalists</title>
    ...
    <div class="container">
      <section class="category-hero">
        ...
        <div class="category-content">
          ...
          <p>Discover guitarists, pianists, drummers, violinists, and other instrumental talents for concerts, sessions, and events.</p>
        ...
        <div class="artist-grid compact-grid">
          <?php if (!$artists): ?>
            <article class="artist-card artist-card-empty">
              <h3>No Instrumentalists found</h3>
